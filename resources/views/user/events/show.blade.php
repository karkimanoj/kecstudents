			...
			<div class="row mb-4">
				...
				<div class="col-md-3">
					...
					@if($event->user_id == Auth::user()->id)
						<div class="card  card_shadow w-100 borderless mt-4" id="user_widget">
			                ...
			                <div class="card-body ">
			                    ...
			                    <li class="nav-item">
			                      ...
			                      <a class="nav-link active" href="{{route('user.projects.index')}}">Projects </a>
			                    </li>
			                    <li class="nav-item">
	              	...
	              	<div class="row">
	              		<div class="col-md-11 offset-md-1 mt-4 pl-3 pt-3  bg-white" id="pop_event_div" style="font-size: 0.8rem">
							  ...
							  <li class="nav-item list-group-item">
							    ...
							    <br>
							    <i class="fab fa-cuttlefish" ></i>minor event(bct)</a>
							  </li>
							  <li class="nav-item list-group-item">
