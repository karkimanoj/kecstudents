...
<div class="main-container">
    <div class="row ">
        <div class="col-md-10 offset-md-1 ">
        	<h2><center>EDIT TENANT</center></h2>
            ...
            <div class="row">
              ...
              <div class="panel panel-default mt-2">
                    <div class="panel-body">
                        <form method="POST" action="{{route('tenants.update', $tenant->id)}} " enctype="multipart/form-data" id="form">
                                {{method_field('PUT')}}
                                {{csrf_field()}}                                  
                                <div class="row form-group mt-2{{ $errors->has('name')?'has-error':'' }} ">
                                    <div class="col-md-3">    
                                     ...
                                     <div class="col-md-8">
                                         <input type="text" name="name" minlength="4" class="form-control" value="{{$tenant->name or old('name')}}" required maxlength="191">
                                ...
                                <div class=" row form-group mt-2 ">
                                    ...
                                    <div class="col-md-4 form-group {{ $errors->has('subdomain')?'has-error':'' }}">
                                        <input type="text" name="subdomain" minlength="4" class="form-control" value="{{$tenant->subdomain or old('subdomain')}}" required maxlength="191">
                                         <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-4 form-group {{ $errors->has('identifier')?'has-error':'' }}">
                                        <input type="text" name="identifier" minlength="3" maxlength="3" class="form-control" value="{{$tenant->identifier or old('identifier')}}" required >
                                         <small class="form-text text-muted">
                                ...
                                <div class="row form-group mt-2">
                                    <div class="col-md-3">    
                                        <label class="right m-r-20">Logo:</label>
                                    </div>    
                                     <div class="col-md-8">
                                         <img src="{{asset($tenant->logo)}}" width="150" height="150">

                                     </div>                 
                                </div>
                                <div class=" row form-group mt-2 {{ $errors->has('logo')?'has-error':'' }}" >
                                    <div class="col-md-3">               
                                       <label class="right mr-2">Replace Existing Logo </label>
                                    </div>
                                    <div class="col-md-8">
                                        <input type="file" name="logo" class="form-control" accept="image/*" id="tenant_logo" >
                                        <small class="form-text text-muted">
                                ...
                                <div class="row form-group mt-3 {{ $errors->has('description')?'has-error':'' }} ">
                                    <div class="col-md-3">    
                                     ...
                                     <div class="col-md-8">
                                         <textarea class="form-control" required rows="10" name="description" >{!!$tenant->description or old('description') !!}</textarea>
